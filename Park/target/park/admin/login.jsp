...
<div class="login layui-anim layui-anim-up">
    ...
    <form class="layui-form" method="post" >
        <input name="userid" id="userid"  type="text" class="layui-input" required lay-verify="required" placeholder="请输入用户名">
        <hr class="hr15">
        <input name="upass" id="upass" type="password" class="layui-input" required lay-verify="required" placeholder="请输入密码">
        <hr class="hr15">
        <input name="securityCode" required lay-verify="required" placeholder="请输入验证码" type="text" autocomplete="off" style="width: 190px;">
        <img src="serial/getimage.action" οnclick="VerificationCode()" name="securityCode" id="Verify" style="cursor:hand;" alt="看不清，换一张" width="116"
             height="36">
        <hr class="15">
        <input value="登录" lay-submit lay-filter="login" style="width:100%;" type="submit" onclick="return loginch()">
        <hr class="hr20">
    </form>
</div>
    ...
    $(function () {
        ...
        layui.use('form', function () {
            ...
            form.on('submit(login)', function (data) {
                $.ajax({
                    async: true,
                    url: "${pageContext.request.contextPath}/login/backLogin.action",
                    type: "POST",
                    dataType: "text",
                    data: data.field,
